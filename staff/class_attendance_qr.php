                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body mb-4">
                                ...
                                try {
                                    // Fetch meeting data
                                    $stmt = $pdo->prepare("
                                       SELECT id, date, class_id, status, start_time, end_time, type, wmsu_radius
                                ...
                                <div id="printableArea">
                                    ...
                                    <div class="row text-center">
                                        ...
                                        <div class="col" id="noPrint">
                                            ...
                                            <?php if ($meetingData['wmsu_radius'] == 'on') { ?>
                                                <!-- Turn off WMSU Radius button with an icon -->
                                                <button class="btn btn-warning" id="turnOffWmsuRadius"
                                                    onclick="turnWmsuRadius('off', <?php echo $_GET['class_id']; ?>, '<?php echo $_GET['classAttendanceId']; ?>')">
                                                    <i class="bi bi-x-circle" style="margin-right: 5px;"></i> Turn off WMSU
                                                    Radius
                                                </button>
                                            <?php } else { ?>
                                                <!-- Turn on WMSU Radius button with an icon -->
                                                <button class="btn btn-success" id="turnOffWmsuRadius"
                                                    onclick="turnWmsuRadius('on', <?php echo $_GET['class_id']; ?>, '<?php echo $_GET['classAttendanceId']; ?>')">
                                                    <i class="bi bi-circle" style="margin-right: 5px;"></i> Turn on WMSU
                                                    Radius
                                                </button>
                                            <?php } ?>
                                        ...
                                        <script>
                                            ...
                                            function turnWmsuRadius(action, classId, meetingId) {
                                                // Display SweetAlert confirmation
                                                let message = (action === 'on') ?
                                                    'Are you sure you want to turn on WMSU Radius?' :
                                                    'Are you sure you want to turn off WMSU Radius?';
                                                ...
                                                Swal.fire({
                                                    ...
                                                    icon: 'warning',
                                                    showCancelButton: true,
                                                    confirmButtonText: `Yes, turn ${action} WMSU Radius`,
                                                    cancelButtonText: 'No, cancel',
                                                    reverseButtons: true
                                                }).then((result) => {
                                                    if (result.isConfirmed) {
                                                        // Redirect to the respective action based on on/off status
                                                        window.location.href = `turnOffWmsuRadius.php?action=${action}&class_id=${classId}&meeting_id=${meetingId}`;
                                                    }
                                                });
                                            }
                                        </script>
