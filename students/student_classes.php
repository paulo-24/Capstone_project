...
<style>
    ...
    ul {
        ...
        margin: 0;
        padding-left: 20px;
        /* Default left padding for bullets */
        line-height: 1.3;
        /* Default line spacing for lists */
    }

    li {
        margin-bottom: 8px;
        /* Default margin between list items */
        padding: 2px 0;
        /* Default padding for list items */
        font-size: 14px;
        /* Default list item font size */
    }
    ...
    .modal-dialog {
        max-width: 600px;
        /* Default modal width for larger screens */
        margin: 1.75rem auto;
        /* Center the modal */
    }
    ...
    /* Media Query for Screens ≤ 700px (Tablets and Small Screens) */
    @media screen and (max-width: 700px) {
        ...
        .table {
            font-size: 12px;
            /* Smaller table font size for readability */
            border: 1px solid #dee2e6;
        }
        ...
        /* Stack table layout for small screens */
        .table-responsive {
            overflow-x: auto;
        ...
        .table-responsive thead {
            display: none;
            /* Hide headers on small screens for simplicity */
        }
        ...
        .table-responsive td::before {
            ...
            left: 0;
            width: 40%;
            /* Reduced width for labels to fit 700px */
            padding-left: 5px;
            /* Reduced padding for labels */
            font-weight: bold;
            font-size: 12px;
            /* Smaller label text */
        }
        ...
        .btn-csms {
            ...
            width: auto;
            /* Allow buttons to shrink but not full-width unless necessary */
        }
        ...
        ul {
            padding-left: 15px;
            /* Reduced left padding for bullets */
            line-height: 1.1;
            /* Tighter line spacing */
        }
        ...
        .col-sm-2 {
            ...
            margin-bottom: 5px;
            /* Minimal spacing between stacked columns */
        }
        ...
        .d-flex.align-items-center {
            ...
            /* Align items to the start for readability */
        }

        .ms-auto {
            margin-left: 0 !important;
            /* Remove auto margin to prevent layout issues */
        }

        .modal-dialog {
            max-width: 90%;
            /* Nearly full width for modals on small screens */
            margin: 0.5rem auto;
            /* Reduced margin for centering */
            height: 90vh;
        ...
        .modal-footer {
            padding: 8px;
            /* Reduced padding for modal sections */
        }
    ...
    @media screen and (max-width: 700px) {
        ...
        body {
            font-size: 10px;
            /* Very small font size for base text */
        }
    ...
    /* activity section your class activities */
</style>
