...
$queryAll = "SELECT * FROM student_notifications WHERE user_id = :user_id  ORDER BY id DESC";
...
if ($userId) {
	...
	$queryUnread = "SELECT * FROM student_notifications WHERE status = 'unread' AND user_id = :user_id ORDER BY id DESC LIMIT 4";
				...
				<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="alertsDropdown">
					<div class="dropdown-menu-header">
						<?php if ($notificationCount > 0) { ?>
							...
							<div class="dropdown-item text-center">
								<a href="processes/students/notifications/read_all.php"><button id="readAll"
										class="btn btn-link">Read All</button></a>
								<a href="processes/students/notifications/delete_all.php"><button id="deleteAll"
										class="btn btn-link text-danger">Delete All</button></a>
							</div>
						<?php } else { ?>
							...
							<div class="list-group-item">
								<div class="row g-0 align-items-center">
									...
									<div class="col-2 text-end">
										<form action="processes/students/notifications/read.php" method="POST"
											class="d-inline">
											<input type="hidden" name="id" value="<?php echo $notification['id']; ?>">
											<button type="submit" class="btn btn-link p-0">Read</button>
										</form>
										<form action="processes/students/notifications/delete.php" method="POST"
											class="d-inline">
											<input type="hidden" name="id" value="<?php echo $notification['id']; ?>">
					...
					<?php if ($notifCount > 0) { ?>
						<div class="dropdown-menu-footer">
							<a href="#" class="text-muted" data-bs-toggle="modal" data-bs-target="#notificationsModal">Show
								all
								notifications</a>
						</div>
					<?php } ?>
					...
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<a href=""><button type="button" class="btn btn-danger" data-bs-toggle="modal"
									data-bs-target="#deleteAllModal">Delete All</button></a>
							<a href=""><button type="button" class="btn btn-info" data-bs-toggle="modal"
									data-bs-target="#readAllModal">Read
									All</button></a>
