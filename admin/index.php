											...
											<div class="card">
												<div class="card-body text-center">
													<div class="row">
														<div class="col ">
															<h5 class="card-title"
																style="margin-bottom: 20px !important">Quick Access</h5>
														</div>
													</div>
													<div class="row text-center">
														<div class="col">
															<a href="teacher_management.php" class=" nav-link-shortcut">
																<span>Teachers</span>
															</a>
															<a href="subject_management.php" class="nav-link-shortcut">
																<span>Subjects</span>
															</a>
														</div>

														<div class="col">
															<a href="class_management.php" class="nav-link-shortcut">
																<span>Classes</span>
															</a>
									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												<div class="row">
													<div class="col mt-0">
														<h5 class="card-title">No. of Teachers</h5>
													</div>
															...
															var chart = new Chart(ctx, {
																...
																data: {
																	datasets: [{
																		...
																		backgroundColor: ['#4caf50', '#d3d3d3'], // Colors for progress and remaining
